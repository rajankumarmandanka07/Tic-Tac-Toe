...
SELECT e.DEPARTMENT_ID, e.SALARY AS EMPLOYEE_SALARY, max_salaries.MAX_SALARY
FROM employees e
...
SELECT d.DEPARTMENT_NAME, d.DEPARTMENT_ID, CONCAT(e.FIRST_NAME, ' ', e.LAST_NAME) AS FULL_NAME, e.EMAIL, e.PHONE_NUMBER, e.SALARY
FROM DEPARTMENTS d
